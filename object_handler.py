...
class ObjectHandler:
    def __init__(self, game):
        ...
        add_npc(TaggedNPC(game, path='Assets/NPCs/glass_cannon/0.png', pos=(2, 19), speed=0.5, health=500, tag=4))
        add_npc(TaggedNPC(game, path='Assets/NPCs/glass_cannon/0.png', pos=(15, 19), speed=0.5, health=500, tag=4))
        ...
        add_pick_up(HealthPickUp(game, pos=(1.5, 9.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 10.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 11.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 12.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 13.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 14.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 15.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 16.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 17.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 18.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 19.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 20.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 21.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 22.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 23.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 24.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 25.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 26.5)))
        add_pick_up(HealthPickUp(game, pos=(1.5, 27.5)))
        ...
        add_interactable(BlackHole(game, path='Assets/Animated_Sprites/BlackHole/0.png', pos=(29.5, 18.5), teleport_location=(31.5, 5.5)))
