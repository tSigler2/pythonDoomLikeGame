...
class Animated_Sprite(SpriteObj):
    def __init__(self, game, path='Assets/Animated_Sprites/Green_Torch/0.png', pos=(11.5, 3.5), scale=0.8, shift=0.15, animation_time=120):
